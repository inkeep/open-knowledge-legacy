...
| Integration | Tier 1 bridge matrix + C1-C9 server-authoritative                 | `packages/app/tests/integration/bridge-matrix.test.ts`, `c1-*.test.ts` through `c9-*.test.ts`               | `bun run test`                                             |
| Stress      | 5-client × 30s mixed edits with convergence timing                | `packages/app/tests/stress/server-authoritative-stress.test.ts`                                              | `bun run test:stress:*`                                    |

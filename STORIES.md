...
- **[x] U1.2** A knowledge worker can insert a component (Callout, Tabs, Card, Steps, Accordion, Video, Frame, CodeGroup, ImageZoom, Files, TypeTable, Banner, InlineTOC, Mermaid, Audio (15 families / 21 entries)) via slash command and edit its props through a visual panel

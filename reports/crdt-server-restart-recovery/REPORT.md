...
The recommended architecture is a **Yjs binary sidecar at `<contentDir>/.open-knowledge/ystate/<docName>.bin`, treated as a disposable recovery cache, with markdown preserved as the canonical source of truth, and a server-instance-ID check over Hocuspocus authentication as defense-in-depth.**

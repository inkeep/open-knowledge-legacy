...
This page describes the architecture as validated during the init spike (March 2026). The codebase has evolved since -- history repo, ContentFilter, branch parking, agent identity attribution, and page CRUD APIs have been added. For the current production topology, see [Service Topology](/internals/service-topology).
</Callout>

...
<Cards>
  ...
  <Card title="gbrain search" href="/guides/gbrain-search">
  ...
  <Card title="Assets and embeds" href="/guides/assets-and-embeds">
    Drop files, use Obsidian-style `![[embeds]]`, dedup duplicates, tune upload.
  </Card>

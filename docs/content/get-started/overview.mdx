...
- New to Open Knowledge? Start with [Install](/get-started/install) and the [Quickstart](/get-started/quickstart).
- Setting up an editor? Pick yours from [Integrations](/integrations/claude-code).
- Looking up a tool, command, or config field? [MCP](/reference/mcp), [Configuration](/reference/configuration), and [CLI](/reference/cli).

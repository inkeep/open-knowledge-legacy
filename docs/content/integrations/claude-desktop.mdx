...
- `--force` — rebuild even if the install state shows the skill is already current
...
A related ["Save and Replace" bug](https://github.com/anthropics/claude-code/issues/46836) silently no-ops same-name reinstalls. Same workaround: delete first, then re-upload.

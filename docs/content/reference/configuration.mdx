...
| --- | --- | --- | --- |
| `content.dir` | string | `"."` | Content directory, relative to project root. Excluded paths live in `.okignore` — see [Ignore patterns](/features/ignore-patterns). |

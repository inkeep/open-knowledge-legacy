...
The MCP server gives AI agents structured access to your knowledge base. Most tools work whether or not the editor is open. Write tools require the editor — Open Knowledge starts it for you on the first write.
...
| `get_config` / `set_config` | Read or update `.ok/config.yml` |

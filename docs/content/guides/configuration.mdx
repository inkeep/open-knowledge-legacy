...
| `content.include` | `string[]` | `["**/*.md"]` | Glob patterns for files to include in the document system |
| `content.exclude` | `string[]` | `[]` | Glob patterns to explicitly exclude (combined with .gitignore) |

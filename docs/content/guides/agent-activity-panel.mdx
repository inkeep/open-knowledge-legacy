...
Drag the thin rail on the left edge of the panel to resize. Width is remembered across tabs and reloads. If you prefer the keyboard, tab focus to the rail and use Arrow keys (16 px step, 64 px with Shift) or Home / End to jump to the widest / narrowest allowed size. The panel opens at 480 px on first use and stays within [320, 900] px so it never hides the entire editor.

...
- Auto-generated catalogs in `.ok/catalogs/` are still maintained
- Document tools (`write_document`, `edit_document`, `delete_document`, etc.) are **not** available since there is no CRDT layer to route through
</Tab>
</Tabs>

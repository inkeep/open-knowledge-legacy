...
| `read_document`                               | Both      | Read a document with enriched frontmatter + history-repo attribution                         |
...
| `rollback_to_version`                         | Connected | Restore a document to a historical history-repo commit                                       |
| `get_history`                                 | Connected | Query the history-repo version timeline                                                      |
| `save_version`                                | Connected | Checkpoint the project to a named history-repo commit                                        |

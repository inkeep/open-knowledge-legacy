...
Note: `content.include` and `content.exclude` produce a hard error at config-load time directing you to `.okignore` — see [Content filtering](/guides/content-filtering) for the migration recipe.

...
1. In the Claude Desktop App sidebar: **Customize** → **Skills**.
2. Click the **+** button.
...
There's a related "Save and Replace" bug ([#46836](https://github.com/anthropics/claude-code/issues/46836)) where same-name re-installs silently no-op. Same workaround: delete first, then re-upload.

...
function summarizeStructuredContentForLog(
  ...
  if (isPlainObject(structured.ui)) {
    summary.uiBaseUrl =
      typeof structured.ui.baseUrl === 'string' || structured.ui.baseUrl === null
        ? structured.ui.baseUrl
        : undefined;
    summary.uiPort =
      typeof structured.ui.port === 'number' || structured.ui.port === null
        ? structured.ui.port
        : undefined;
  }

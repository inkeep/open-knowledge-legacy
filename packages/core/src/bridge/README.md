...
- **Dev / test (default).** Let it propagate. `bun run check`, fuzz harnesses, and integration tests fail loudly — this is the signal that a merge dropped content. See SPEC §6 R1 and the 10 K-seed Tier-3 fuzz gate.

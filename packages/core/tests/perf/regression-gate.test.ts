/**
 * R4 regression-gate synthetic-regression tests.
 *
 * Per SPEC §6 R4 AC: "R4 synthetic-regression test proves gate fires when
 ...
 * IS the comparison logic. Running the harness is the tier-2 task's job.
 *

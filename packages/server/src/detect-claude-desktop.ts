 ...
 * once." This is the signal the spec's `ok init` hint and the Electron
 ...
 *
 * See specs/2026-04-24-skill-dual-track-install/SPEC.md D12 and
 * evidence/claude-desktop-detection-existing.md.
 */

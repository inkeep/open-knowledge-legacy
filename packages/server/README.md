...
Hocuspocus CRDT server library — persistence, file-watcher, agent sessions, shadow repo, and HTTP API. Embedded in the Vite dev server (`packages/app`) and the published CLI (`packages/cli`).

/**
 * QA-016: Multi-client DOM-layer verification for Observer A Path B.
 *
 * Complements `bridge-matrix.test.ts` multi-client FR-4 test (US-006) at the
 ...
 *
 * Scope aligned with SPEC FR-3 / FR-4 / US-006:

 ...
 *
 * Uses page.evaluate for clipboard injection to avoid flakiness.
 * Tests retry up to 3x per Playwright config.
 *
...
/** Inject text/plain content via clipboard API and paste it */
...
test.describe('V1 paste baseline — text/plain content through WYSIWYG', () => {
  test.beforeEach(async ({ page }) => {
    await page.goto(`${BASE}/?doc=test-doc`);

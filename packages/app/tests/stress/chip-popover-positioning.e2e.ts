 ...
 * past the first viewport, click the chip, assert (a) the panel is
 * on-screen, (b) the panel is anchored near the chip (vertical gap
 * within ~200 px, horizontal centers within ~200 px). Both assertions
 * fail on the unfixed code; both pass after the fix.
 *

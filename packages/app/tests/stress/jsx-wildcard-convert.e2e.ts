/**
 * Layer C (Tier 2): Playwright regression pin for the wildcard + render-error
 ...
 * flip (commit d83a45b6) — i.e., restoring the pre-dispatch flip — fails
...
// ── S20: wildcard auto-convert on mount ───────────────────────────────

/**
 * S2 reproduction — warm switch-back to a previously-loaded small doc after
 ...
 * completed" moment.
 *
 * Pre-fix baseline (AC13): warmSwitchMs ≥ 500.
 * Post-fix target (AC21): warmSwitchMs < 100 AND README content continuity

...
const ALLOWLIST: readonly AllowlistEntry[] = [
  ...
  },
  {
    ...
    rationale:
      'cosmetic-only per coordinate-space analysis — DialogHeader internal padding (px-4 pt-4 pb-2) places title at (29, 32), clearing traffic lights by ~2px; close X is right-aligned',
  },
];

 ...
 *
 * Sister test to T17 (`branch-switched-with-stale-embed-resolution.test.ts`)
 ...
 *
 * Why this matters: T17 depends on the head-watcher firing for cross-branch
 ...
 * T17 fails because the test-doc's content is byte-identical across

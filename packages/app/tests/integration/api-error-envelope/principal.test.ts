/**
 * Per-handler narrow-integration smoke test for `handlePrincipal` (US-010).
 *
...
import { PrincipalResponseSchema, ProblemDetailsSchema } from '@inkeep/open-knowledge-core';

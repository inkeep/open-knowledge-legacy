 ...
 *
 * Expected behavior (SPEC §6 / Shape 2+):
 ...
 *
 * Relevant stories: US-003 (client-persistence attachment), US-004
 * (buffer-and-replay on mismatch-recycle), US-005 (sidecar removed, markdown
 * is source of truth).
 */

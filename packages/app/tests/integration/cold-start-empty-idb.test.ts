/**
 * T13 — Cold start with empty IDB syncs cleanly from a just-restarted server.
 *
 ...
 * (new serverInstanceId). This is the common "user opens Open Knowledge for
 ...
 *
 * Relevant stories: US-003 (client-persistence attachment), US-005 (sidecar
 * removed, markdown is source of truth).
 */

  ...
  return (
    ...
    >
      ...
      <path
        ...
        className={cn('ok-blob-body', clicked && 'ok-blob-clicked')}
      />
      ...
      <ellipse
        ...
        rx={1.2722}
        ry={1.9083}
        className={cn('ok-blob-eye', clicked && 'ok-blob-eye-hidden')}
      />
      <ellipse
        ref={rightEyeRef}
        cx={RIGHT_EYE_CX}
        ...
        rx={1.2722}
        ry={1.9083}
        className={cn('ok-blob-eye ok-blob-eye-right', clicked && 'ok-blob-eye-hidden')}
      />

      {/* Happy eyes — rounded ^^ arcs, shown only when clicked */}
      <path
        d={`M${LEFT_EYE_CX - 1.5} ${EYE_CY + 0.3} Q${LEFT_EYE_CX} ${EYE_CY - 2.2}, ${LEFT_EYE_CX + 1.5} ${EYE_CY + 0.3}`}
        strokeWidth="1.2"
        strokeLinecap="round"
        fill="none"
        className={cn('ok-blob-happy-eye', !clicked && 'ok-blob-eye-hidden')}
      />
      <path
        d={`M${RIGHT_EYE_CX - 1.5} ${EYE_CY + 0.3} Q${RIGHT_EYE_CX} ${EYE_CY - 2.2}, ${RIGHT_EYE_CX + 1.5} ${EYE_CY + 0.3}`}
        strokeWidth="1.2"
        strokeLinecap="round"
        fill="none"
        className={cn('ok-blob-happy-eye', !clicked && 'ok-blob-eye-hidden')}

...
export function FileSidebar() {
  ...
  async function handleRename(target: FileTreeTarget) {
    ...
    try {
      ...
      console.warn('[FileSidebar] rename failed:', err);
  ...
  async function handleDelete(target: FileTreeTarget) {
    ...
    try {
      ...
      if (activeDocName && deleted.has(activeDocName)) {
      ...
      console.warn('[FileSidebar] delete failed:', err);
      setError('Network error — please try again');
      setBusyPath(null);
    }
  }

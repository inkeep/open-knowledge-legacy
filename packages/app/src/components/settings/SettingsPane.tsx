...
/**
 * Sync section — surface the git auto-sync toggle in Settings so users have
...
function SyncSection() {
  ...
  // Hide the row entirely when there's no git remote — toggling sync on
  // would only error out. (Matches the badge's `dormant && !hasRemote` hide.)

 ...
 * default context menu surfaces. This is deliberate per the D9 research
 * signal: Docmost/SilverBullet/HedgeDoc let Chromium handle context menus
 * because there's no file manager to Reveal into anyway.
 *

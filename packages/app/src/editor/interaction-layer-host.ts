 ...
 *
 * See V2 spec FR4 + §9.2 for the architecture context.
 */
...
export function getInteractionLayer(editor: Editor): InteractionLayerHandle {
  ...
  // InteractionLayerEditor interface accepts duck-typed access. The CLAUDE.md
  // WARN rule permits reading it (for the non-throwing proxy check) provided
  // the access is typed as unknown-cast, which it is here.

 ...
 * rather than in any component file. This pattern was introduced in Pass 1
 * of the Electron M1 local-review loop (NavigatorApp) and extended to the
 * remaining launcher surfaces in Pass 3 / Pass 4.
 */

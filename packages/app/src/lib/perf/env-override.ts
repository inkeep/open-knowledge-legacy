/**
 * Test-time override for numeric constants that govern cache / pool / activity
 * sizing. Used by the perf measurement campaign (M0–M6 in
 * `.claude/plans/inherited-herding-sparkle.md`) to sweep values without
 * rebuilding.
 *

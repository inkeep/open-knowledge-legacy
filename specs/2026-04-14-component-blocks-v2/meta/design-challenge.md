...
**Status:** CHALLENGED
**Suggested resolution:** Restructure §9.14's opening to lead with: "Establishes the foundational CM-in-PM infrastructure (Architectural Precedent #18) that serves both rawMdxFallback (P0) and future per-block source-mode toggle (NG10). The investment is proportional to the platform primitive it creates, not just the rawMdxFallback use case."

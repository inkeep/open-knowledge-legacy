...
- Spec §6 explicitly lists `suggest_links(page)` as Should-priority and IMPLEMENTATION\_MILESTONES.md M4 as its home. This story is the "pull forward" decision.

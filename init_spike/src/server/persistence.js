...
export function safeContentPath(documentName) {
...
export function createPersistenceExtension() {
    return {
        async onLoadDocument({ document, documentName }) {
            ...
            if (json) {
                ...
                if (xmlFragment.length === 0) {
                    ...
                    console.log(`[persistence] Loaded ${filePath} into Y.Doc (${xmlFragment.length} children)`);
                }
            }
        ...
        async onStoreDocument({ document, documentName }) {
            ...
            const frontmatter = typeof fmFromDoc === 'string' ? fmFromDoc : frontmatterCache.get(documentName) || '';

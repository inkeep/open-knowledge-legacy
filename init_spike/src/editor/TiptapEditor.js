...
export const TiptapEditor = forwardRef(function TiptapEditor(_props, ref) {
    ...
    useImperativeHandle(ref, () => ({
        ...
        applyThreeWayMerge(snapshotMarkdown, userEditedMarkdown) {
            if (!editor) {
                return {
                    selective: false,
                    userChangedCount: 0,
            ...
            provider.document.transact(() => {
                ...
                mergeResult = threeWayMerge(provider.document, yFragment, snapBody, userBody, mdManager, editor.schema);
            });
            return mergeResult;
        },
    ...
    return (_jsx("div", { className: "tiptap-editor", children: _jsx(EditorContent, { editor: editor }) }));
});

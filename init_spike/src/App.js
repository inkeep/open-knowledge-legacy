...
export function App() {
    ...
    return (_jsxs("div", { style: { maxWidth: '800px', margin: '0 auto', padding: '24px' }, children: [_jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '16px' }, children: [_jsx("h1", { style: { margin: 0 }, children: "Open Knowledge" }), _jsx("button", { type: "button", onClick: handleToggle, style: {
                            padding: '6px 16px',
                            borderRadius: '4px',
                            border: '1px solid #ccc',
                            background: isSourceMode ? '#e8f0fe' : '#fff',
                            cursor: 'pointer',
                        }, children: isSourceMode ? 'WYSIWYG' : 'Source' })] }), toggleError && (_jsxs("div", { style: {
                    padding: '8px 12px',
                    marginBottom: '12px',
                    background: '#fee',
                    ...
                    borderRadius: '4px',
                    color: '#c00',
                }, children: ["Parse error: ", toggleError] })), isSourceMode && _jsx(SourceEditor, { content: sourceContent, onChange: setSourceContent }), _jsx("div", { style: { display: isSourceMode ? 'none' : 'block' }, children: _jsx(TiptapEditor, { ref: editorRef }) })] }));
}

...
**Related:** [[specs/2026-04-21-multi-agent-presence/SPEC]]
...
reproduce                                                                                |
| 5  | Cmd+R flashes "waiting for collab server" orange banner           | Nick          | ✅     | PR #231 (merged 2026-04-21) — grace period before ConnectingBanner suppresses the remount flash                  | Dima                                                                                                            |
...
| V5  | `bun x` vs `npx` confusion in shared quickstart                  | Miles noted     | 🗣️🔵  | PR #225 (merged, `ok` bin alias), PR #227 (open, audit + install-UX docs reconciliation); specs [[specs/2026-04-20-cli-distribution-and-install-ux/SPEC]] + [[specs/2026-04-20-install-ux-docs-reconciliation/SPEC]] | Andrew                 |
...
| V13 | `open-knowledge clone` blocked by "not permitted" for some users | Andrew (self)   | 🗣️🔵  | PR #244 (open, 2026-04-21) shadow-repo single mode + auto-git-init replaces silent fail with explicit R6 copy ("install git or run `git init`, then re-run"); [[specs/2026-04-21-shadow-repo-single-mode/SPEC]] | Andrew                 |
...
- Presence spec: [[specs/2026-04-21-multi-agent-presence/SPEC]]
